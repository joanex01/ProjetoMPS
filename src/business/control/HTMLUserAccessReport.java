...
public class HTMLUserAccessReport extends UserAccessReport {
    ...
    @Override
    protected void generateBody(Usuario usuario, BufferedWriter bufferedWriter) throws IOException{
        String username = usuario.getUsername();
        //String timeStamp = usuario.getTimestamp();
        //int totalAccessCount = usuario.getTotalAccessCount();
